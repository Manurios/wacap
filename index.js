...
//
const BotName = 'BOT ./Manurios'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/manuuuriosss__/'; // Nama Instagramlu cok
const whatsapplu = '0831-4192-6935'; // Nomor whatsapplu cok
